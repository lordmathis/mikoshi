...
import { IconButtonTooltip } from "../shared/icon-button-tooltip.tsx";
  ...
  return (
    <div
      className={cn(
        ...
        isUser ? "bg-background cp-cut-x-16 cp-hover-user" : "bg-cp-surface4 cp-cut-z-16 cp-hover-assistant"
      )}
    >
      {isUser ? (
